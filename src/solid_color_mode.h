...
if( colorCounter == 2 || colorCounter == 3) { fill_solid( leds, NUM_LEDS, CHSV(32, 255, 255));} // Verde ?
if( colorCounter == 4 || colorCounter == 5) { fill_solid( leds, NUM_LEDS, CHSV(64, 255, 255));} // Naranja ?
